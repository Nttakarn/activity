    ...
    <v-container fluid style="margin: 0px; padding: 0px; width: 100%">
        <v-layout wrap>
            <v-app-bar color="" class="">
                <v-btn icon color="#FF0000" :to="{ name: 'home' , params: { ID_student: ID_student}}" class="">
                    <v-icon>mdi-home</v-icon>
                </v-btn>

                <v-toolbar-title class="white--text" style="white"> เช็คกิจกรรม </v-toolbar-title>
                <v-spacer></v-spacer>
...
export default {
    ...
    data: () => ({
        ...
        items: [{
            ...
            {
                status: 'สาย', days: '1 พ.ย. 64',ID: 4
            },
            {
                status: 'มา', days: '2 พ.ย. 64',ID: 5
            },
            {
                status: 'มา', days: '12 พ.ย. 64',ID: 6
            },
            {
                status: 'มา', days: '22 พ.ย. 64',ID: 7
            },
            {
                status: 'ขาด', days: '1 ธ.ค. 65',ID: 8
            },
            {
                status: 'มา', days: '3 ธ.ค. 65',ID: 9
            },
            {
                status: 'ขาด', days: '12 ธ.ค. 65',ID: 10
            },
            {
                status: 'มา', days: '1 ม.ค. 65',ID: 11
            },
            {
                status: 'มา', days: '8 ม.ค. 65',ID: 12
            },
        ],
